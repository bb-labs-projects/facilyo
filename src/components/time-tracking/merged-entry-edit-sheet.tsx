...
import { Building2, Wrench, Trees, Scissors, ClipboardList, Sparkles, Clock, Pencil } from 'lucide-react';
import {
  Sheet,
  SheetContent,
  SheetHeader,
...
const ACTIVITY_CONFIG: Record<ActivityType, { label: string; icon: typeof Wrench; color: string; bgColor: string }> = {
  ...
  reinigung: { label: 'Reinigung', icon: Sparkles, color: 'text-cyan-600', bgColor: 'bg-cyan-50' },
};
