...
function generateInvoicePDF(invoice: InvoiceData, billing: BillingSettings): jsPDF {
...
export async function GET(
  ...
  try {
    ...
    const invoice = rawInvoice as unknown as InvoiceData;
    ...
    const billing = rawBilling as unknown as BillingSettings;
